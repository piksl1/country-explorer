        ...
        <section className="relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 py-20 md:py-32">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                Discover information about countries around the globe and trace IP addresses 
                to their geographic locations with our powerful tools.
              </motion.p>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-4">Countries Explorer</h3>
                <p className="text-muted-foreground mb-6">
                  Browse and search countries worldwide with detailed information about population, region, languages, and more.
                </p>
                <Link to="/" className="text-primary font-medium inline-flex items-center gap-2 hover:underline">
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-4">IP Address Tracker</h3>
                <p className="text-muted-foreground mb-6">
                  Trace any IP address or domain to locate its geographical position and get detailed information about the region.
                </p>
                <Link to="/ip-tracker" className="text-primary font-medium inline-flex items-center gap-2 hover:underline">
              ...
              >
                ...
                <p className="text-muted-foreground mb-6">
                  Quickly find information with our intuitive search functionality, filtering countries by name or region.
                </p>
                <Link to="/" className="text-primary font-medium inline-flex items-center gap-2 hover:underline">
                  Try Searching <ArrowRight className="w-4 h-4" />
                </Link>
              </motion.div>
            </div>
          </div>
              ...
              <div className="p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-muted-foreground max-w-md">
                    Start discovering countries and tracking IP addresses with our comprehensive tools.
                  </p>
                </div>
